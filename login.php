...
<script>
 $(function(){
  ...
  <h1 class="text-center text-white px-4 py-5" id="page-title"><b>Online Eyewear Shop - PHP</b></h1>
<div class="login-box">
  <!-- /.login-logo -->
    ...
    <div class="card-body">
      ...
      <form id="ulogin-form" action="" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="username" autofocus placeholder="Username">
        ...
        <div class="row">
          <div class="col-8">
            <a href="http://localhost/oews/">Go to Website</a>
          </div>
          <!-- /.col -->
          <div class="col-4">
          ...
          <div class="col-12 text-center">
            <a href="http://localhost/oews/register.php">Signup</a>
          </div>
        </div>
      </form>
      <!-- /.social-auth-links -->
